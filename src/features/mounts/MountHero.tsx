...
const STATS = [
  { id: 'mountTypes',      value: 4, accent: 'text-ember-300' },
  { id: 'tameableSpecies', value: 7, accent: 'text-frost-300' },
  { id: 'petTypes',        value: 6, accent: 'text-purple-300' },
] as const;

// Quinfall mounts/pets official video — autoplayed, muted, looped via the playlist trick.
const YT_VIDEO_ID = '3hGXZaob8yQ';
const YT_EMBED_SRC =
